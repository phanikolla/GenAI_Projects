...
st.set_page_config(page_title="Question and Answer with RAG") ### Modify Heading

new_title = '<p style="font-family:sans-serif; color:Green; font-size: 42px;">Question and Answer with RAG 🎯</p>'
...
go_button = st.button("📌Learn GenAI with PHANI KUMAR", type="primary") ### Button Name
