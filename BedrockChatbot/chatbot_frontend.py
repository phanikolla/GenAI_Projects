...
st.title("Welcome to my chatbot, KOLLA :sunglasses:") # **Modify this based on the title you want in want
...
input_text = st.chat_input("Chat with Phani's KOLLA Bot here") # **display a chat input box
if input_text: 
